...
for i in range(1, 5):
    ...
    clyde_img = pygame.transform.scale(pygame.image.load(os.path.join('assets', 'ghost_images', 'orange.png')), (45, 45))
    spooked_img = pygame.transform.scale(pygame.image.load(os.path.join('assets', 'ghost_images', 'powerup.png')), (45, 45))
    dead_img = pygame.transform.scale(pygame.image.load(os.path.join('assets', 'ghost_images', 'dead.png')), (45, 45))
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
